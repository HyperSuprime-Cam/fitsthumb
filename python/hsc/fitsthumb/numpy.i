...
/* This is a copy of numpy-1.8.1/doc/swig/numpy.i
   with a slight modification. Modified places are marked with "#CUSTOMIZED#"
*/
...
{ namespace { // #CUSTOMIZED# All fragment codes (including those below) are enclosed in anonymous namespace
...
{ namespace {
                                               ...
                                               int*      is_new_object)
  {
    ...
    {
      //#CUSTOMIZED# py_obj = PyArray_FROMANY(input, typecode, 0, 0, NPY_ARRAY_DEFAULT);
      py_obj = PyArray_FROMANY(input, typecode, 0, 0, NPY_ARRAY_ALIGNED | NPY_ARRAY_FORCECAST | NPY_ARRAY_DEFAULT);
